...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'sonar2csv_shape.cmdline': {'sonar2csv_shape.cmdline.main': ('cmdline.html#main', 'sonar2csv_shape/cmdline.py')},
            ...
            'sonar2csv_shape.webgui': { 'sonar2csv_shape.webgui.cleanup': ('webgui.html#cleanup', 'sonar2csv_shape/webgui.py'),
                                        ...
                                        'sonar2csv_shape.webgui.remove_old_zips': ( 'webgui.html#remove_old_zips',
                                                                                    'sonar2csv_shape/webgui.py'),
                                        ...
                                        'sonar2csv_shape.webgui.upload_directory': ( 'webgui.html#upload_directory',
                                                                                     'sonar2csv_shape/webgui.py')}}}
